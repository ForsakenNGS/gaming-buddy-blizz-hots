...
class HotsPlayer extends EventEmitter {
  ...
  toJSON() {
    return {
      index: this.index,
      name: this.name,
      nameFinal: this.nameFinal,
      team: this.team.color,
      character: this.character,
      detectionError: this.detectionError,
      locked: this.locked,
      imagePlayerName: this.imagePlayerName,
      imageHeroName: this.imageHeroName,
      recentPicks: this.recentPicks
    };
  }
